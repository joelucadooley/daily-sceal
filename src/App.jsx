...
// In production, CONTENT is fetched from /data/today.json
// Generated once daily by a server-side script (scripts/generate.js)
// Format: { date, focal, stories: [{ id, title, summary, category, categoryIr, timeAgo, levels: { 10, 25, 50, 75, 100 } }] }
// Each level value is a string with [[irish|english]] markers already embedded.
// Zero AI calls per user — all generation happens once at build/cron time.

const SNAP_LEVELS = [10, 25, 50, 75, 100];

const snapPct = pct => SNAP_LEVELS.reduce((a, b) => Math.abs(b - pct) < Math.abs(a - pct) ? b : a);
...
// Fallback used only when today.json is unavailable.
// Each story has pre-generated levels so the slider works immediately with no API call.
const FALLBACK_STORIES = [
  {
    id: "f1",
    title: "Government Announces Ambitious New Housing Plan",
    ...
    levels: {
      ...
      50: "The Irish [[rialtas|government]] has [[nochtaithe|unveiled]] a new [[straitéis|strategy]] to [[tógáil|build]] fifty thousand [[tithe|homes]] over the [[trí bliana|next three years]], with a [[fócas|focus]] on [[tithíocht inacmhainne|affordable housing]] in Dublin, Cork, and Galway. Tá an [[plean|plan]] dírithe ar [[teaghlaigh|families]] ar [[ioncam íseal|low income]].",
      75: "Tá an [[rialtas|government]] Éireannach tar éis [[straitéis|strategy]] nua a [[nochtadh|unveil]] chun caoga míle [[teach|home]] a [[tógáil|build]] thar na [[trí bliana|three years]] amach romhainn, le [[fócas|focus]] ar [[tithíocht inacmhainne|affordable housing]] i mBaile Átha Cliath, Corcaigh, agus Gaillimh. [[Dúirt|said]] an [[Taoiseach]] go raibh an [[plean|plan]] ríthábhachtach.",
      100: "Tá an [[rialtas|government]] [[Éireannach|Irish]] tar éis [[straitéis|strategy]] nua a [[nochtadh|unveil]] chun caoga míle [[teach|home]] a [[tógáil|build]] thar na [[trí bliana|three years]] amach [[romhainn|ahead of us]]. Tá [[fócas|focus]] ar [[tithíocht inacmhainne|affordable housing]] i mBaile Átha Cliath, Corcaigh, agus Gaillimh, agus ar [[teaghlaigh|families]] ar [[ioncam íseal|low income]] go [[háirithe|particularly]].",
    }
  },
  {
    id: "f2",
    title: "Leinster Rugby Reach Champions Cup Quarterfinals",
    ...
    levels: {
      ...
      50: "[[Dhaingniú|Secured]] Leinster [[rugbaí|Rugby]] a [[áit|place]] sna Champions Cup [[ceathrúchrainn|quarterfinals]] le [[cluiche|performance]] [[láidir|convincing]] in éadan Toulouse ag an Aviva [[Staidiam|Stadium]] Dé [[hAoine|Friday]] [[san oíche|at night]].",
      ...
      100: "[[Dhaingniú|Secured]] Leinster [[rugbaí|Rugby]] a [[áit|place]] sna Champions Cup [[ceathrúchrainn|quarterfinals]] le [[cluiche|performance]] [[láidir|convincing]] in [[éadan|against]] Toulouse ag an Aviva [[Staidiam|Stadium]] Dé [[hAoine|Friday]] [[san oíche|at night]]. [[Bhí|was]] an [[slua|crowd]] ar [[bís|edge of seat]] [[ón tús|from the start]] agus [[d'fhéach|watched]] gach [[duine|person]] an [[bua|victory]] le [[háthas|joy]].",
    }
  },
  {
    id: "f3",
    title: "Wild Atlantic Way Voted Top European Scenic Drive",
    ...
    levels: {
      ...
      50: "Tá bealach cósta [[cáiliúil|famous]] na hÉireann [[vótáilte|voted]] an [[tiomáint|drive]] [[radharcach|scenic]] is [[fearr|best]] san Eoraip ag [[irisleabhar|magazine]] taistil [[ceannasach|leading]], ag [[treisiú|boosting]] [[dóchas|hopes]] do [[séasúr|season]] [[turasóireachta|tourism]] [[samhraidh|summer]] [[taifead|record]].",
      75: "Tá [[bealach|route]] cósta [[cáiliúil|famous]] na hÉireann [[vótáilte|voted]] an [[tiomáint radharcach|scenic drive]] is [[fearr|best]] san [[Eoraip|Europe]] ag [[irisleabhar|magazine]] taistil [[ceannasach|leading]]. Tá [[dóchas|hope]] ann anois go mbeidh [[séasúr|season]] [[turasóireachta|tourism]] [[taifead|record]] ann an [[samhradh|summer]] seo.",
      100: "Tá [[bealach|route]] [[cósta|coastal]] [[cáiliúil|famous]] na [[hÉireann|Ireland]] [[vótáilte|voted]] an [[tiomáint radharcach|scenic drive]] is [[fearr|best]] san [[Eoraip|Europe]] ag [[irisleabhar|magazine]] [[taistil|travel]] [[ceannasach|leading]]. Tá [[dóchas|hope]] ann go mbeidh [[séasúr|season]] [[turasóireachta|tourism]] [[taifead|record]] ann an [[samhradh|summer]] seo, le [[méadú|increase]] mór ar [[cuairteoirí|visitors]] ón [[gcoigríoch|abroad]].",
    }
  },
  {
    id: "f4",
    title: "New Irish Language Tech Hub Opens in Galway",
    ...
    levels: {
      ...
      50: "[[Osclaíodh|opened]] [[ionad|centre]] [[teicneolaíochta|technology]] nua i nGaillimh atá [[dírithe|dedicated]] ar [[bogearraí|software]] Gaeilge agus uirlisí AI a [[fhorbairt|develop]]. [[Cruthaíodh|created]] níos mó ná céad [[post|job]] nua sa [[réigiún|region]] mar [[thoradh|result]].",
      75: "[[Osclaíodh|opened]] [[ionad|centre]] [[teicneolaíochta|technology]] nua i nGaillimh atá [[dírithe|dedicated]] ar [[bogearraí|software]] Gaeilge agus [[uirlisí|tools]] AI a [[fhorbairt|develop]]. [[Cruthaíodh|created]] níos mó ná céad [[post|job]] nua sa [[réigiún|region]]. [[Dúirt|said]] [[urlabhraí|spokesperson]] gur [[céim|step]] mhór é seo don [[teanga|language]].",
      100: "[[Osclaíodh|opened]] [[ionad|centre]] [[teicneolaíochta|technology]] nua i nGaillimh atá [[dírithe|dedicated]] ar [[bogearraí|software]] Gaeilge agus [[uirlisí|tools]] AI a [[fhorbairt|develop]]. [[Cruthaíodh|created]] níos mó ná céad [[post|job]] nua sa [[réigiún|region]] mar [[thoradh|result]]. Measann [[saineolaithe|experts]] gur [[céim|step]] [[stairiúil|historic]] é seo don [[Ghaeilge|Irish language]] sa [[domhan|world]] [[digiteach|digital]].",
    }
  },
  {
    id: "f5",
    title: "Record Numbers Visit National Museums This Year",
    ...
    levels: {
      ...
      50: "Tá [[músaeim|museums]] agus [[gailearaithe|galleries]] náisiúnta na hÉireann [[tuairiscithe|reported]] líon [[taifead|record]] [[cuairteoirí|visitors]], le níos mó ná ceithre milliún [[duine|person]] ag [[freastal|attend]] ar [[institiúidí|institutions]] [[cultúrtha|cultural]] ar fud na [[tíre|country]] ó [[Eanáir|January]].",
      75: "Tá [[músaeim|museums]] agus [[gailearaithe|galleries]] [[náisiúnta|national]] na hÉireann ag [[tuairisciú|reporting]] líon [[taifead|record]] [[cuairteoirí|visitors]] i [[mbliana|this year]]. [[Tháinig|came]] níos mó ná ceithre milliún [[duine|person]] chuig [[institiúidí|institutions]] [[cultúrtha|cultural]] ar fud na [[tíre|country]] ó [[Eanáir|January]] i [[leith|onwards]].",
      100: "Tá [[músaeim|museums]] agus [[gailearaithe|galleries]] [[náisiúnta|national]] na [[hÉireann|Ireland]] ag [[tuairisciú|reporting]] líon [[taifead|record]] [[cuairteoirí|visitors]] i [[mbliana|this year]]. [[Tháinig|came]] níos mó ná ceithre [[milliún|million]] [[duine|person]] chuig [[institiúidí|institutions]] [[cultúrtha|cultural]] ar fud na [[tíre|country]] ó [[Eanáir|January]] i [[leith|onwards]], rud a [[léiríonn|shows]] an [[suim|interest]] mór atá ag [[daoine|people]] sa [[chultúr|culture]] [[Éireannach|Irish]].",
    }
  },
  {
    id: "f6",
    title: "Met Éireann Forecasts Warmest June in Decades",
    ...
    levels: {
      ...
      25: "Met Éireann has [[réamhaisnéisithe|forecast]] an exceptionally [[te|warm]] and [[tirim|dry]] [[Meitheamh|June]], with [[teocht|temperatures]] [[ag súil|expected]] to reach twenty-six [[céim|degrees]] in [[codanna|parts]] of the [[tír|country]].",
      50: "Tá Met Éireann tar éis [[Meitheamh|June]] [[te|warm]] agus [[tirim|dry]] a [[réamhaisnéis|forecast]] don [[tír|country]]. Táthar ag [[súil|expecting]] go [[sroichfidh|reach]] [[teochtaí|temperatures]] fiche a sé [[céim|degrees]] i [[gcodanna|parts]] den [[tír|country]] seo.",
      75: "Tá Met Éireann tar éis [[Meitheamh|June]] [[eisceachtúil|exceptional]] [[te|warm]] agus [[tirim|dry]] a [[réamhaisnéis|forecast]]. Táthar ag [[súil|expecting]] go [[sroichfidh|reach]] na [[teochtaí|temperatures]] fiche a sé [[céim|degrees]] i [[gcodanna|parts]] den [[tír|country]]. Beidh sé ar cheann de na [[míonna|months]] is [[teo|hottest]] le [[blianta|years]] fada.",
...
async function fetchTodayContent() {
  // In production this is a static JSON file generated once daily by scripts/generate.js
  const r = await fetch("/data/today.json", { signal: AbortSignal.timeout(5000) });
  ...
  return (
    <div style={{ animation: "fadeIn 0.25s ease" }}>
      ...
      <div style={{ background: "#fff", borderRadius: 12, padding: "18px", marginBottom: 14, border: "1px solid #e0d8cc" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", fontFamily: "sans-serif", fontSize: "0.66rem", color: "#ccc", marginBottom: 14 }}>
  ...
  return (
    <div style={{ animation: "fadeIn 0.25s ease" }}>
      <div style={{ background: NAVY, borderRadius: 16, padding: "28px 22px", marginBottom: 18, position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ marginTop: 8, fontFamily: "sans-serif", fontSize: "0.81rem", color: "#93b4cc" }}>
      ...
      <div style={{ textAlign: "center", marginTop: 16, padding: "16px", fontFamily: "sans-serif", fontSize: "0.75rem", color: "#aaa", lineHeight: 2 }}>
        <div style={{ marginBottom: 6, fontStyle: "italic", color: "#bbb" }}>
          Ar mhaith leat Gaeilge a fhoghlaim? Tá tú san áit cheart.
        </div>
        <div>
          Created by{" "}
          <a href="https://github.com/joelucadooley" target="_blank" rel="noopener noreferrer"
            style={{ color: NAVY, fontWeight: 600, textDecoration: "none", borderBottom: "1px solid #93b4cc" }}>
            Joe Luca Dooley
          </a>
        </div>
        <div style={{ marginTop: 4, color: "#ccc" }}>
          News sourced from RTÉ · Powered by Claude AI · Open to all
        </div>
      </div>
    </div>
  );
...
export default function DailySceal() {
  ...
  useEffect(() => {
    fetchTodayContent()
      ...
      .catch(() => {}) // silently fall back to FALLBACK_STORIES
